...
<?php if(isset($form) && !empty($form)):
    ...
    foreach($formFields[0] as $field){ ?>
        <div class="row form-group" id="field-<?php echo $i; ?>">
        <hr>
        <div class="col-sm-12">
        <div class="row form-group">
            <div class="col-sm-1">
                <div class="row">
                    <div class="col-xs-6">
                        <strong class="field-number"><?php echo $i; ?></strong>
                    </div>
                    <div class="col-xs-6">
                        <a href="#" class="up upanddown" data-field="<?php echo $i; ?>">↑</a>
                        <a href="#" class="down upanddown" data-field="<?php echo $i; ?>">↓</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-7">
                <label for="field[<?php echo $i; ?>][form-name]">Nom du champ</label>
                <input type="text"  value="<?php echo $field['name']; ?>" name="field[<?php echo $i; ?>][form-name]" id="field[<?php echo $i; ?>][form-name]" class="form-control" placeholder="Nom du champ" required/>
                <a href="#" class="dupliquer" data-field="<?php echo $i; ?>">Dupliquer</a>
                <a href="#" class="move" data-field="<?php echo $i-1; ?>">Copier sur un autre formulaire</a>
            </div>
            <div class="col-sm-3">
                <label for="field[<?php echo $i; ?>][form-type]">Type de champ</label>
                <select name="field[<?php echo $i; ?>][form-type]" class="form-control" id="field[<?php echo $i; ?>][form-type]" data-field="<?php echo $i; ?>">
                    <?php foreach($inputs as $val){ ?>
                        <option <?php echo isset($field['type']) && $field['type'] == str_replace(' ', '_',$val) ? 'selected' : ''; ?> value="<?php echo str_replace(' ', '_',$val); ?>"><?php echo $val; ?></option>
                    <?php } ?>
                </select>
            </div>
            <div class="col-sm-1">
                <a href="#" data-field="<?php echo $i; ?>" class="delete upanddown">×</a>
                <a href="#" data-field="<?php echo $i; ?>" class="open upanddown">+</a>
            </div>
        </div>
        <div class="options-<?php echo $i; ?>" style="display: none;">
        <?php
        switch($field['type']):
            case 'open_container' : ?>
                <div class="row form-group">
                    <div class="col-md-4">
                        <input type="text" name="field[<?php echo $i; ?>][form-container]" class="form-control" value="<?php echo htmlspecialchars($field['container']); ?>" placeholder="Type du container">
                    </div>
                    <div class="col-md-4">
                        <input type="text" name="field[<?php echo $i; ?>][form-container-class]" data-field="<?php echo $i; ?>" value="<?php echo htmlspecialchars($field['args']['class']); ?>" class="form-control" placeholder="Class du container">
                    </div>
                    <div class="col-md-4">
                        <input type="text" name="field[<?php echo $i; ?>][form-container-id]" value="<?php echo htmlspecialchars($field['args']['id']); ?>" class="form-control" placeholder="id du container">
                    </div>
                </div>
                <?php
                break;
            ...
            case 'select' : ?>
                ...
                <div class="row form-group">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input type="text" name="field[<?php echo $i; ?>][form-id]" class="form-control" value="<?php echo htmlspecialchars($field['args']['id']); ?>" placeholder="Id du champ"/>
                        </div>
                        <div class="form-group">
                            <input type="text" name="field[<?php echo $i; ?>][form-class]" class="form-control" value="<?php echo htmlspecialchars($field['args']['class']); ?>" placeholder="Class du champ"/>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input type="text" name="field[<?php echo $i; ?>][form-label]" class="form-control" value="<?php echo htmlspecialchars($field['args']['label']); ?>" placeholder="Label"/>
                        </div>
                        <div class="form-group">
                            <input type="text" name="field[<?php echo $i; ?>][form-label-class]" class="form-control" value="<?php echo htmlspecialchars($field['args']['labelClass']); ?>" placeholder="Class du label"/>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input type="checkbox" id="field[<?php echo $i; ?>][form-required]" name="field[<?php echo $i; ?>][form-required]" value="1" checked/> <label for="field[<?php echo $i; ?>][form-required]" <?php echo $field['args']['required'] ? 'checked' : ''; ?> class="label-checkbox"> Required</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" id="field[<?php echo $i; ?>][form-label-after]" name="field[<?php echo $i; ?>][form-label-after]" value="1"/> <label for="field[<?php echo $i; ?>][form-label-after]" <?php echo $field['args']['labelAfter'] ? 'checked' : ''; ?> class="label-checkbox">Placer le label après le champ</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    <div class="col-sm-4">
                        <select name="field[<?php echo $i; ?>][form-order-by]" id="field[<?php echo $i; ?>][form-order-by]" class="form-control">
                            <option value="default" <?php echo isset($field['args']['orderBy']) && $field['args']['orderBy'] == 'default' ? 'selected' : '' ; ?>>Défaut</option>
                            <option value="croissant" <?php echo isset($field['args']['orderBy']) && $field['args']['orderBy'] == 'croissant' ? 'selected' : '' ; ?>>Croissant</option>
                            <option value="décroissant" <?php echo isset($field['args']['orderBy']) && $field['args']['orderBy'] == 'décroissant' ? 'selected' : '' ; ?>>Décroissant</option>
                        </select>
                    </div>
                </div>
                <label>Options du select</label>
                <?php foreach($field['args']['options'] as $key => $option){ ?>
                    <div class="row option-select" id="option-select<?php echo $i; ?>-<?php echo (int)$key +1; ?>">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <input type="text" id="field[<?php echo $i; ?>][form-select-option-name][<?php echo (int)$key +1; ?>]" name="field[<?php echo $i; ?>][form-select-option][<?php echo (int)$key +1; ?>][name]" value="<?php echo $option['content']; ?>" placeholder="Nom de l\'option" class="form-control" required/>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <input type="text" id="field[<?php echo $i; ?>][form-select-option-name][<?php echo (int)$key +1; ?>]" name="field[<?php echo $i; ?>][form-select-option][<?php echo (int)$key +1; ?>][value]" value="<?php echo $option['value']; ?>" placeholder="Valeur de l\'option" class="form-control" />
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <input type="radio" id="field[<?php echo $i; ?>][form-select-option-selected][<?php echo (int)$key +1; ?>]" name="field[<?php echo $i; ?>][form-select-option-selected]" value="<?php echo (int)$key +1; ?>" <?php echo $option['select'] ? 'checked' : ''; ?>  class="form-control" />
                            <label for="field[<?php echo $i; ?>][form-select-option-selected][<?php echo (int)$key +1; ?>]" class="label-checkbox">Ce champ est séléctionné</label>
                        </div>
                        <div class="col-sm-1">
                            <a href="#" data-field="<?php echo $i; ?>" data-option="<?php echo (int)$key +1; ?>" class="upanddown removeoption">×</a>
                        </div>
                    </div>
                <?php } ?>
                <button class="button button-primary button-large left" data-action="add-option" data-field="<?php echo $i; ?>" type="button">Ajouter une option</button>
                <hr>
                <?php break;
            ...
            case 'taxonomy' : ?>
                <div class="row form-group">
                    <div class="col-sm-4">
                        <label for="field[<?php echo $i; ?>][form-taxonomy]">Taxonomy</label>
                        <select data-field="<?php echo $i; ?>" name="field[<?php echo $i; ?>][form-taxonomy]" id="field[<?php echo $i; ?>][form-taxonomy]" class="form-control">
                            ...
                            foreach($taxonomies as $key => $taxonomy){
                                ...
                                ?>
                                <option value="<?php echo $taxonomy->name; ?>" <?php echo substr($field['name'],9) == $taxonomy->name ? 'selected' : ''; ?> ><?php echo $taxonomy->label; ?></option>
                            <?php
                            } ?>
                        </select>
                    </div>
                    <div class="col-sm-4">
                        <label for="field[<?php echo $i; ?>][form-taxonomy-type]">Type de champ</label>
                        <select data-field="<?php echo $i; ?>" name="field[<?php echo $i; ?>][form-taxonomy-type]" id="field[<?php echo $i; ?>][form-taxonomy-type]" class="form-control">
                            <option value="select" <?php if($field['args']['taxonomyType'] == 'select') echo 'selected'; ?>>Select</option>
                            <option value="hidden" <?php if($field['args']['taxonomyType'] == 'hidden') echo 'selected'; ?>>Hidden</option>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input type="text" name="field[<?php echo $i; ?>][form-id]" value="<?php echo htmlspecialchars($field['args']['id']); ?>" class="form-control" placeholder="Id du champ"/>
                        </div>
                        <div class="form-group">
                            <input type="text" name="field[<?php echo $i; ?>][form-class]" class="form-control" value="<?php echo htmlspecialchars($field['args']['class']); ?>" placeholder="Class du champ"/>
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input type="text" name="field[<?php echo $i; ?>][form-empty-field]" class="form-control" value="<?php echo htmlspecialchars($field['args']['emptyField']); ?>" placeholder="Valeur du champ vide"/>
                        </div>
                        <div class="form-group">
                            <input type="text" name="field[<?php echo $i; ?>][form-value]" class="form-control" value="<?php echo htmlspecialchars($field['args']['value']); ?>" placeholder="Valeur du champ"/>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input type="checkbox" id="field[<?php echo $i; ?>][form-required]" name="field[<?php echo $i; ?>][form-required]" value="1" <?php echo $field['args']['required'] ? 'checked' : ''; ?> /> <label for="field[<?php echo $i; ?>][form-required]" class="label-checkbox"> Required</label>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input type="checkbox" id="field[<?php echo $i; ?>][form-autocomplete]" name="field[<?php echo $i; ?>][form-autocomplete]" value="1" <?php echo $field['args']['autocomplete'] ? 'checked' : ''; ?>/> <label for="field[<?php echo $i; ?>][form-autocomplete]" class="label-checkbox"> Autocomplete</label>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input type="checkbox" id="field[<?php echo $i; ?>][form-label-after]" name="field[<?php echo $i; ?>][form-label-after]" value="1" <?php echo $field['args']['labelAfter'] ? 'checked' : ''; ?>/> <label for="field[<?php echo $i; ?>][form-label-after]" class="label-checkbox">Placer le label après le champ</label>
                        </div>
                    </div>
                </div>
                <?php
            ...
            case 'file' : ?>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input type="text" name="field[<?php echo $i; ?>][form-allowed]" class="form-control" value="<?php echo implode(',',$field['args']['allowed']); ?>" placeholder="Extensions autorisés (espacer par des virgules)"/>
                        </div>
                        <div class="form-group">
                            <input type="text" name="field[<?php echo $i; ?>][form-acf-field]" class="form-control"  value="<?php echo htmlspecialchars($field['args']['acfField']); ?>" placeholder="Nom du champ ACF galerie"/>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input type="text" name="field[<?php echo $i; ?>][form-max-size]" value="<?php echo isset($field['args']['maxSize']) ? $field['args']['maxSize'] : '' ; ?>" class="form-control" placeholder="Taille maximum d'un fichier uploadé (en ko)"/>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input type="checkbox" id="field[<?php echo $i; ?>][form-multiple]" name="field[<?php echo $i; ?>][form-multiple]" value="1" <?php echo $field['args']['multiple'] ? 'checked' : ''; ?>  /> <label for="field[<?php echo $i; ?>][form-multiple]" class="label-checkbox"> Multiple</label>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
            ...
            default :
                ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <input type="text" name="field[<?php echo $i; ?>][form-placeholder]" class="form-control" value="<?php echo htmlspecialchars($field['args']['placeholder']); ?>" placeholder="Placeholder du champ"/>
                            </div>
                            <div class="form-group">
                                <input type="text" name="field[<?php echo $i; ?>][form-value]" class="form-control" value="<?php echo htmlspecialchars($field['args']['value']); ?>" placeholder="Valeur du champ"/>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <input type="checkbox" id="field[<?php echo $i; ?>][form-readonly]" name="field[<?php echo $i; ?>][form-readonly]" value="1" <?php echo (isset($field['args']['readOnly']) && $field['args']['readOnly']) ? 'checked' : ''; ?> /> <label for="field[<?php echo $i; ?>][form-readonly]" class="label-checkbox"> Read only</label>
                            </div>
                        </div>
                    </div>
                <?php
        ...
        <div class="col-sm-12">
            <div class="row form-group">
                <div class="col-sm-1">
                    <div class="row">
                        <div class="col-xs-6">
                            <strong class="field-number">1</strong>
                        </div>
                        <div class="col-xs-6">
                            <a href="#" class="up upanddown" data-field="1">↑</a>
                            <a href="#" class="down upanddown" data-field="1">↓</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-7">
                    <label for="field[1][form-name]">Nom du champ</label>
                    <input type="text" name="field[1][form-name]" id="field[1][form-name]" class="form-control" placeholder="Nom du champ" required/>
                    <a href="#" class="dupliquer" data-field="1">Dupliquer</a>
                </div>
                <div class="col-sm-3">
                    <label for="field[1][form-type]">Type de champ</label>
                    <select name="field[1][form-type]" class="form-control" id="field[1][form-type]" data-field="1">
                        <?php foreach($inputs as $val){ ?>
                ...
                <div class="col-sm-1">
                    <a href="#" data-field="1" class="delete upanddown">×</a>
                    <a href="#" data-field="1" class="minify upanddown">-</a>
                </div>
            </div>
            <div class="options-1">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input type="text" name="field[1][form-id]" class="form-control" placeholder="Id du champ"/>
                        </div>
                        <div class="form-group">
                            <input type="text" name="field[1][form-class]" class="form-control" placeholder="Class du champ"/>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input type="text" name="field[1][form-placeholder]" class="form-control" placeholder="Placeholder du champ"/>
                        </div>
                        <div class="form-group">
                            <input type="text" name="field[1][form-value]" class="form-control" placeholder="Valeur du champ"/>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input type="text" name="field[1][form-label]" class="form-control" placeholder="Label"/>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input type="text" name="field[1][form-label-class]" class="form-control" placeholder="Class du label"/>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input type="checkbox" id="field[1][form-required]" name="field[1][form-required]" value="1" checked/> <label for="field[1][form-required]" class="label-checkbox"> Required</label>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input type="checkbox" id="field[1][form-autocomplete]" name="field[1][form-autocomplete]" value="1" checked/> <label for="field[1][form-autocomplete]" class="label-checkbox"> Autocomplete</label>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input type="checkbox" id="field[1][form-label-after]" name="field[1][form-label-after]" value="1"/> <label for="field[1][form-label-after]" class="label-checkbox">Placer le label après le champ</label>
                        </div>
                    </div>
                </div>
            </div>
