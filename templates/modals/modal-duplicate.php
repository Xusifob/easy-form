        ...
        <div class="modal-content">
            <form action="<?php echo $_SERVER['REQUEST_URI'];?>&noheader=true" method="post">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><?php _e('Dupliquer un champ sur un autre formulaire', 'easy-form'); ?></h4>
                </div>
                <div class="modal-body">
                    <input type="hidden" name="form-duplicate-field-id"/>
                    <label for="form-duplicate-form"><?php _e('Nom du nouveau formulaire', 'easy-form'); ?></label>
                    ...
                    if(isset($form)):
                        ?>
                        <input type="hidden" name="form-id" value="<?php /** @var $form WP_Post */ echo $form->ID; ?>">
                    <?php endif; ?>
                ...
                <div class="modal-footer">
                    <input type="submit" value="<?php _e('Copier', 'easy-form'); ?>" class="button button-primary button-large left"/>
                </div>
            </form>
        </div>
    </div>
