...
$output .= '<link rel="stylesheet" href="' . get_bloginfo('wpurl') . '/wp-content/plugins/easy-form/library/css/style.css">';
$output .= '<link rel="stylesheet" href="' . get_bloginfo('wpurl') . '/wp-content/plugins/easy-form/library/css/shCore.css">';
$output .= '<link rel="stylesheet" href="' . get_bloginfo('wpurl') . '/wp-content/plugins/easy-form/library/css/shThemeDefault.css">';
