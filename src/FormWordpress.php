...
class FormWordpress extends Form
{
   ...
   private function addStatsInfos($kind){
     ...
     * @return array
     */
    private static function getIpData()
    {
