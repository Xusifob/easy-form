...
ob_start(); ?>
    <div class="ef-input">
        <label for="field[fieldId][settings][allow-other]" class="label-checkbox">
            <input type="checkbox" id="field[fieldId][settings][allow-other]" name="field[fieldId][settings][allow-other]" value="checked" />
            <?php _e('Allow user to enter a custom value', EF_get_domain()); ?>
        </label>
    </div>
<?php
