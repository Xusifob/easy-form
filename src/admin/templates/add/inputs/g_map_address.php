...
ob_start(); ?>
	<div class="ef-input">
		<label for="field[fieldId][settings][api_key]"><?php _e('API Google Maps Places', EF_get_domain()); ?></label>
    ...
    <div class="ef-input">
		<label for="field[fieldId][attributes][countries]"><?php _e('Restrict the search to some countries', EF_get_domain()); ?></label>
