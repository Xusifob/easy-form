<div class="ef-content" >
    <table class="ef-table">
        ...
        <tr class="ef-table--separator">
            <td class="ef-rules">
                <h4><?php _e('Success',EF_get_domain()); ?></h4>
                <p><?php _e('This part let you define the success message to display to the user',EF_get_domain()); ?></p>
            </td>
            <td class="ef-table-content">
                <div class="ef-input">
                    <label for="settings[success-message]"><?php _e('Success Message', EF_get_domain()); ?></label>
