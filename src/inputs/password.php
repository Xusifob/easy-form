...
class EF_Password_Input extends EF_Input
{
    ...
    public function __toString()
    {
        ...
        if(isset($uniqId)) {
            $template .= sprintf('<p class="password-checked ef-password-checked" min-length="%s" min-strength="%s" id="%s" pattern-number="%s" pattern-symbol="%s" pattern-upper="%s" pattern-flat-lower="%s" pattern-flat-number="%s" pattern-flat-upper="%s" password-similar="%s" ></p>',
                ...
                $this->getSetting('password-equals')
