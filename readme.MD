...
````
 cd wp-content/plugins/easy-form/tests
 composer install
 ````
and then open the file easy-form/tests/index.php into your web browser


## Changelogs

### Version 0.6 :
 * Update documentation for better understanding (In Progress)
 * Add unit tests & tests using Symfony Crawler (In Progress)
 * Correct bug on export forms
